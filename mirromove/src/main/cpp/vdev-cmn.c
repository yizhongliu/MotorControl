...
void vdev_avsync_and_complete(void *ctxt)
{
    ...
    LOGE("vdev_avsync_and_complete : complet: %d , cmnvars: %d", c->completed_vpts, c->cmnvars->vpts);
    LOGE("vdev_avsync_and_complete : vpktn: %d ", c->cmnvars->vpktn);
